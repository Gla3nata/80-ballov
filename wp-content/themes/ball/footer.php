        ...
        <div class="container">
            <div class="footer__inner">
                ...
                <div class="footer__log">
                    <a class="footer__log-link" href="">Войти</a>
                    <a class="footer__log-link" href="">Оплатить</a>
                </div>

                <ul class="footer__social">
                    <li class="footer__social-item">
                        <a class="footer__social-link" target="_blank" rel="nofollow" href="https://vk.com/80ballov">
                ...
                <div class="footer__phone">
                    <a class="phone" href="tel:+74959709966">+7 (495) 970-99-66</a>
                </div>
                <div class="footer__mail">80ballov@godege.ru</div>

                <div class="footer__contacts">
                    <p>© 2020 УЦ «Годограф»</p>
                    <p>Проект 80 Баллов</p>
                    <p>ИП: Стерлядкин Андрей Викторович</p>
                    <p>ИНН: 773137757657</p>
                    <p>ОГРН: 317774600363751</p>
                </div>

                <ul class="footer__links">
                    <li class="footer__links-item">Политика конфиденциальности</li>
                    <li class="footer__links-item">Договор оферты регулярных платежей</li>
                    <li class="footer__links-item">Договор оферты</li>
                </ul>

                <ul class="footer__links">
                    <li class="footer__links-item">Очные занятия</li>
                    <li class="footer__links-item">Франшиза курсов ЕГЭ и ОГЭ</li>
                    <li class="footer__links-item">Вакансии центра</li>
                    <li class="footer__links-item">Контакты</li>
                    <li class="footer__links-item">Блог</li>
                </ul>

                <ul class="footer__links">
                    <li class="footer__links-item">Математика</li>
                    <li class="footer__links-item">Обществознание</li>
                    <li class="footer__links-item">Биология</li>
                    <li class="footer__links-item">Английский язык</li>
                    <li class="footer__links-item">Литература</li>
                    <li class="footer__links-item">Информатика</li>
                </ul>

                <div class="footer__license">
                    <img class="footer__license-img" src="images/license.png" alt="license">
                    <p class="footer__license-descr">Государственная лицензия</p>
                </div>
            </div>
        </div>
    </footer>
